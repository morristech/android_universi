...
LIBRARY_NAME=universi
LIBRARY_ARTIFACT_NAME="support-${LIBRARY_NAME//_/-}"
LIBRARY_VERSION=1.0.6
LIBRARY_REPO="git@github.com:universum-studios/android_${LIBRARY_NAME}.git"
LIBRARY_DIR_ARTIFACTS=../artifacts/universum/studios/android/support/${LIBRARY_ARTIFACT_NAME}/${LIBRARY_VERSION}/
